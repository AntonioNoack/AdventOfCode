...
fun nextInvalidId2x(i: Long): Long {
    return when {
        ...
        i <= 1010 -> 10_10
        i < 10000 -> nextInvalidId2x(i, 100)
        i <= 100_100 -> 100_100
        i < 1_000_000 -> nextInvalidId2x(i, 1000)
        i <= 1000_1000 -> 1000_1000
        i < 100_000_000 -> nextInvalidId2x(i, 10_000)
        i <= 10000_10000 -> 10000_10000
        i < 10_000_000_000 -> nextInvalidId2x(i, 100_000)
        i <= 100000_100000 -> 100000_100000
        i < 1_000_000_000_000 -> nextInvalidId2x(i, 1000_000)
